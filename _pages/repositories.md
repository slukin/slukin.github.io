...
- **ARL SCOUT** is The Situated Corpus Of Understanding Transactions, a multi-modal collection of human-robot dialogue in the task domain of collaborative exploration. The **Video-SCOUT** subset is the corpus of long-form, robot recorded videos from these explorations. The corpus was constructed from multi-phased Wizard-of-Oz experiments where human participants gave verbal instructions to a remotely-located robot to move and gather information about its surroundings.
